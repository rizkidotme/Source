...
def get_pdf_content(md5, filename, bludsearch_dir, force, silent):
    converted_txt = os.path.join(bludsearch_dir, get_converted_pdf_txt_filename(md5))
    position_index = os.path.join(bludsearch_dir, get_pdf_positions_filename(md5))
