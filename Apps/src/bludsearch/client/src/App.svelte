...
<main class="flex flex-col h-full bg-slate-100">
  ...
  >
    <h1 class="text-3xl font-mono font-bold inline-flex pr-6 mt-1">bludsearch</h1>
    <SearchBar
      bind:this={searchBar}
      {preferences}
  ...
  <footer class="bg-black text-white py-1 px-4 text-sm">
    <a
      ...
      href="https://github.com/freedmand/bludsearch/blob/main/docs/help.md"
      target="_blank">Help</a
    >
    <a
      class="underline mr-4"
      href="https://github.com/freedmand/bludsearch/blob/main/docs/tutorial.md"
      target="_blank">Tutorial</a
    >
    <a
      class="underline"
      href="https://github.com/freedmand/bludsearch"
